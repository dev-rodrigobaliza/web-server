...
import (
	...
	v1 "web-server/cmd/api/handlers/v1"
...
// DebugStandardLibraryMux registers all the debug routes from the standard library into a new mux bypassing the use of the DefaultServerMux.
// Using the DefaultServerMux would be a security risk since a dependency could inject a handler into our service without us knowing it.
...
// DebugMux registers all the debug standard library routes and then custom debug application routes for the service.
// This bypassing the use of the DefaultServerMux.
// Using the DefaultServerMux would be a security risk since a dependency could inject a handler into our service without us knowing it.
